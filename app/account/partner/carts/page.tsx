...
export default async function PartnerCartsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {!carts?.length ? (
        <div className="rounded-2xl border border-dashed border-[var(--champagne,#2f6b57)]/40 px-6 py-16 text-center">
        ...
        <ul className="divide-y divide-border/70 border-t border-[var(--champagne,#2f6b57)]/20">
          {carts.map((cart: any) => (
            <li key={cart.id} className="flex flex-col gap-3 py-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="min-w-0 space-y-1">
                <Link
                  ...
                  className="font-serif text-lg font-light hover:text-[var(--champagne,#2f6b57)]"
                >
              ...
              <div className="flex shrink-0 items-center gap-6 text-sm">
                ...
                <div className="text-right">
                  ...
                  <p className="font-medium text-[var(--champagne,#2f6b57)]">
