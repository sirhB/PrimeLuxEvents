...
export default async function PartnerHomePage() {
  ...
  return (
    <div className="space-y-12">
      <section className="relative overflow-hidden rounded-[2rem] border border-[var(--champagne,#2f6b57)]/25 bg-gradient-to-br from-[#1a2420] via-[#243830] to-[#2f6b57] px-8 py-14 text-white md:px-12">
        <div
          className="pointer-events-none absolute inset-0 opacity-40"
          style={{
            backgroundImage:
              'radial-gradient(ellipse at 20% 20%, rgba(47,107,87,0.35), transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(95,143,124,0.2), transparent 45%)',
          }}
        />
        <div className="relative max-w-xl space-y-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <Button asChild className="rounded-full bg-[var(--champagne,#2f6b57)] text-black hover:bg-white">
      ...
      <section className="space-y-4 border-t border-[var(--champagne,#2f6b57)]/20 pt-10">
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-[var(--champagne,#2f6b57)]">
      ...
      <section className="grid gap-8 md:grid-cols-2">
        <div className="space-y-3">
          ...
          <Button asChild variant="link" className="h-auto px-0 text-[var(--champagne,#2f6b57)]">
