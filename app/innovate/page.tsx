  ...
  return (
    <div className="relative overflow-hidden bg-[var(--ink)] text-[var(--linen)]">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 50% at 10% 0%, rgba(196,165,116,0.18), transparent 55%), radial-gradient(ellipse 60% 40% at 90% 20%, rgba(138,154,139,0.12), transparent 50%)',
        }}
      />
