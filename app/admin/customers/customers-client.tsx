...
import { EditCustomerSheet } from '@/components/admin/customers/edit-customer-sheet'
...
export function CustomersClient({ customers, totalCount, currentPage, pageSize }: CustomersClientProps) {
    ...
    const handleDelete = async (email: string) => {
        ...
        try {
            ...
            toast.success('Customer deleted (simulated)')
            router.refresh()
        } catch (error) {
        ...
        <div className="flex flex-col gap-8 p-4 md:p-8 bg-[var(--dashboard-background)] min-h-screen">
            ...
            <Tabs defaultValue="all" className="w-full">
                ...
                <TabsContent value="all" className="space-y-6 mt-6 animate-fade-in">
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="glass-card border-[var(--dashboard-border)] text-[var(--dashboard-text)]">
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest cursor-pointer focus:bg-red-500/20 focus:text-red-500 text-red-500"
                                                        >
                    ...
                    {totalCount > 0 && (
                        <PaginationControls
                            hasNextPage={(currentPage - 1) * pageSize + pageSize < totalCount}
