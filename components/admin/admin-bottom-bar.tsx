            ...
            return (
              ...
              >
                <span className="relative">
                  ...
                  {badge > 0 && (
                    <span className="absolute -right-2 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-[var(--dashboard-accent-gold)] px-1 text-[9px] font-bold text-[#000000]">
                      {badge > 99 ? '99+' : badge}
                    </span>
                  )}
                </span>
