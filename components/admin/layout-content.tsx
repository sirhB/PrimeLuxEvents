                ...
                <div className={cn(
                    ...
                    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[var(--dashboard-border)] bg-[var(--dashboard-background)]/80 backdrop-blur-md px-4 md:px-8">
                        <div className="flex items-center gap-4">
                            <div id="admin-search-trigger" className="hidden md:flex relative w-64 group cursor-pointer" onClick={() => setIsCommandPaletteOpen(true)}>
                        ...
                        <div className="flex items-center gap-2 md:gap-4">
                            <div id="admin-notifications-trigger">
                                <AdminNotifications />
                            </div>
                            <div className="h-8 w-px bg-[var(--dashboard-border)] mx-1" />
                            <div id="admin-user-section" className="flex items-center gap-3">
