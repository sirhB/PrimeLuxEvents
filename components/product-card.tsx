            ...
            <article className="spotlight-frame flex h-full flex-col overflow-hidden rounded-2xl border border-border/10 bg-card text-card-foreground shadow-[0_10px_40px_rgba(0,0,0,0.25)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
                ...
                <div className="flex flex-grow flex-col gap-4 p-6">
                    <div className="space-y-2">
                        <h3 className="line-clamp-1 font-serif text-xl font-light tracking-tight text-foreground transition-colors duration-300 group-hover:text-[var(--champagne,#2f6b57)]">
                            {product.name}
                        </h3>
                        {product.description && (
                    ...
                    <div className="mt-auto flex items-center justify-between border-t border-border/5 pt-4">
                        ...
                        {typeof product.quantity_available === 'number' && (
                            <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-[var(--sage,#5f8f7c)]">
