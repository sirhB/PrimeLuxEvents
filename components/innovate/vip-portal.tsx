  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col lg:flex-row">
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="relative min-h-[36vh] overflow-hidden border-b border-[var(--linen)]/10 bg-[#0d1014] lg:border-b-0 lg:border-r">
          <div
            className="absolute inset-0 opacity-50"
            style={{
              background:
                'radial-gradient(ellipse at 50% 0%, rgba(194,168,130,0.35), transparent 55%)',
            }}
          />
