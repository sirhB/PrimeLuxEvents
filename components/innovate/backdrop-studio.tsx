            ...
            <div
              className={cn(
                ...
                frame.id === 'greenery-grid' &&
                  'rounded-sm [background-image:linear-gradient(rgba(95,143,124,0.35)_1px,transparent_1px),linear-gradient(90deg,rgba(95,143,124,0.35)_1px,transparent_1px)] [background-size:18%_22%]',
                frame.id === 'mirror-box' &&
