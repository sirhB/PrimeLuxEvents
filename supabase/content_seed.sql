...
INSERT INTO content (key, value, type) VALUES
('how_it_works.hero.title', 'The PrimeLux Experience', 'text'),
('how_it_works.hero.description', 'We''ve refined the rental process into a seamless digital experience. From browsing to booking, control every detail of your event rentals online, on your time.', 'text'),
('how_it_works.steps', '[
  {
    "id": "01",
    "title": "Browse & Select",
...
('how_it_works.concierge.title', 'Need a Custom Touch?', 'text'),
('how_it_works.concierge.description', 'While our platform is designed for self-service, our Concierge Team is available for large-scale productions requiring custom sourcing or complex logistics.', 'text'),
('how_it_works.concierge.button', 'Contact Concierge', 'text'),
('how_it_works.concierge.image', '/concierge-service.jpg', 'image'),
('how_it_works.faq.title', 'Common Questions', 'text'),
('how_it_works.faq.description', 'Everything you need to know about renting with us.', 'text'),
('how_it_works.faq.items', '[
  {
  ...
  },
  {
    ...
    "answer": "Absolutely. We understand that guest counts and plans change. You can make adjustments to your order up to 14 days before your event date, subject to inventory availability."
  },
  {
    "question": "Is there a minimum order amount?",
    "answer": "We have a $1,000 rental minimum for delivery orders during peak season. For will-call pickups (available for select small items), the minimum is $250."
  }
]', 'json')
ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value, type = EXCLUDED.type;
